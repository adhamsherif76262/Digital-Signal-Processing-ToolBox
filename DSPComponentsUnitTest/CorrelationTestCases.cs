...
0.949263346546471f,
        ...
        public void AutoFastNormalizedCorrelationTestMethod1()
        {
            ...
            StreamWriter str = new StreamWriter("txt.txt");
            str.WriteLine(expectedOutput.Samples.Count);
            for (int i = 0; i < expectedOutput.Samples.Count; i++) {
                str.WriteLine("Expected" + expectedOutput.Samples[i] + " | " + "Actual" + fc.OutputNormalizedCorrelation[i]);
            }
            str.Close();
        ...
        public void CrossFastNonNormalizedCorrelationTestMethod1()
        {
            ...
            for (int i = 0; i < expectedOutput.Samples.Count; i++) {
                Console.WriteLine(expectedOutput.Samples[i] + " | " + fc.OutputNonNormalizedCorrelation[i]);
            }
